  ...
  const messages = [
    {
      ...
      preview:
        "I am very interested in the Senior Developer position at your company...",
      type: "application",
      read: false,
      time: "2 min ago",
      company: "Google",
    },
    {
      ...
      preview:
        "I would like to confirm my interview for the Product Manager role...",
      type: "interview",
      read: false,
      time: "15 min ago",
      company: "Amazon",
    },
    {
      ...
      preview:
        "Thank you for considering my application for the UX Designer position...",
      type: "offer",
      read: true,
      time: "2 hours ago",
      company: "Spotify",
    },
    {
      ...
      preview:
        "I wanted to follow up on my application for the Data Scientist role...",
      type: "followup",
      read: true,
      time: "1 day ago",
      company: "Microsoft",
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-gray-900/50 border-b border-white/10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            {unreadCount > 0 && (
              <Chip className="bg-red-500/20 text-red-400 border border-red-500/30">
                {unreadCount} unread
              </Chip>
            )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="flex flex-wrap gap-1 border-b border-white/10 pb-4">
          {navLinks.map((link) => {
            ...
            const isActive = link.href === "/dashboard/recruiter/messages";
            return (
              <Link
                key={link.href}
                href={link.href}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-gray-900/50 border border-white/10 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-white">
              {messages.filter((m) => m.type === "interview").length}
            </div>
            <div className="text-sm text-purple-400">Interviews</div>
          </div>
          <div className="bg-gray-900/50 border border-white/10 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-white">
              {messages.filter((m) => m.type === "offer").length}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="relative">
              <select className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-2.5 text-white appearance-none cursor-pointer focus:outline-none focus:border-blue-500/50 transition-colors">
                ...
                <option value="application" className="bg-gray-900 text-white">
                  Application
                </option>
                <option value="interview" className="bg-gray-900 text-white">
                  Interview
                </option>
                <option value="offer" className="bg-gray-900 text-white">
                  Offer
                </option>
                <option value="followup" className="bg-gray-900 text-white">
                  Follow-up
                </option>
            ...
            <div className="relative">
              <select className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-2.5 text-white appearance-none cursor-pointer focus:outline-none focus:border-blue-500/50 transition-colors">
                ...
                <option value="read" className="bg-gray-900 text-white">
                  Read
                </option>
                <option value="unread" className="bg-gray-900 text-white">
                  Unread
                </option>
              </select>
              <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${getTypeColor(message.type)}`}
                    >
